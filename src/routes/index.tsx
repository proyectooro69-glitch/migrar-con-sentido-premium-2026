...
const webWhatsappUrl = 'https://wa.me/5358875135'
const instagramUrl = 'https://www.instagram.com/carmen_migrar_con_sentido?stkn=Z2plZm15cTR5d2s0&utm_source=qr'
const emailAddress = 'carmeneperezdiaz@gmail.com'
...
const services = [
  ['Empadronamiento y cita de DNI', 'Nos conocemos antes de que llegues, nos cuentas tu plan y gestionamos tu alojamiento con total transparencia.', FileCheck2],
  ['Residencia de tu cónyuge, si aplica', 'Te acompañamos también en la gestión de residencia de tu pareja, si es tu caso.', Users],
  ['Colegios y CV', 'Orientación para elegir colegio si llegas con hijos, y confección de tu currículum para el mercado laboral español.', GraduationCap],
  ['Inscripción en el SEPE', 'Te recibimos en el aeropuerto y te acompañamos en tu inserción hasta quedar dado de alta.', Landmark],
] as const
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-10">
            <Reveal>
              <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24">
                <div>
                  <p className="eyebrow text-accent">01 / Quiénes somos</p>
                  <h2 className="mt-5 font-serif text-4xl font-bold leading-tight text-primary lg:text-5xl">
                    Somos una red de cubanos-españoles que te espera.
                  </h2>
                  <h3 className="mt-3 font-serif text-2xl font-normal italic text-primary/70 lg:text-3xl">
                    No soltamos tu mano: cruzamos contigo el puente que sin apoyo cruzamos ya.
                  </h3>
                </div>
                <div className="pt-2">
                ...
                <Reveal key={title} className={`delay-${index + 1}`}>
                  <article className="moment-card group overflow-hidden rounded-2xl border border-border bg-white shadow-sm">
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      <span className="absolute bottom-5 left-5 font-serif text-5xl font-bold text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.45)]">
                        {number}
                      </span>
                    </div>
                    {/* Content */}
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-10">
            <Reveal>
              <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
                <div>
                  <p className="eyebrow text-accent">03 / Bienvenida a descendientes por Ley de Memoria Democrática</p>
                  <h2 className="mt-5 max-w-2xl font-serif text-4xl font-bold leading-tight text-primary lg:text-5xl">
                    De cubano a cubano,
                    <br />
                    <span className="font-normal italic text-primary/60">estaremos contigo</span>
                  </h2>
                </div>
                <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
                  Nos conocemos antes de que llegues, nos cuentas tu plan y gestionamos tu alojamiento
                  con total transparencia, te recibimos en el aeropuerto y te acompañamos en tu inserción.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal>
              <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  {[
                    {
                      title: 'Confección de CV',
                      text: 'Un currículum pensado para el mercado laboral español, listo para enviar desde el primer día.',
                      Icon: Sparkles,
                      wa: whatsappUrl,
                    },
                    {
                      title: 'Estudios de mercado',
                      text: 'Información real sobre el terreno antes de emprender en España, para tomar mejores decisiones antes de invertir.',
                      Icon: Landmark,
                      wa: whatsappUrl,
                    },
                    {
                      title: 'Creación de páginas web',
                      text: 'Tu presencia digital y tu web profesional, hechas a medida y pensadas para atraer clientes desde el primer día.',
                      Icon: Sparkles,
                      wa: webWhatsappUrl,
                    },
                    {
                      title: 'Diseño de tarjetas de presentación',
                      text: 'Una imagen profesional para presentarte y conectar con tus primeros clientes en España.',
                      Icon: Landmark,
                      wa: webWhatsappUrl,
                    },
                  ].map(({ title, text, Icon, wa }, i) => (
                ...
                <div className="grid gap-0 md:grid-cols-[0.8fr_1.2fr]">
                  ...
                  <div className="p-8 lg:p-10">
                    ...
                    <div className="mt-6 flex flex-wrap gap-2">
                      {['EXTRANJERÍA', 'DERECHO PENAL', 'DERECHO DE FAMILIA'].map((tag) => (
                    ...
                    <p className="mt-6 text-sm leading-relaxed text-white/65">
                      Te apoyamos en todo proceso legal a través de nuestra letrada especialista en
                      extranjería, penales y familia, quien se encargará de todo hasta el final,
                      aportándote seguridad, profesionalidad y confianza. Revisamos al detalle tu
                      documentación y, de ser necesario, la gestionamos.
                    </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-10 border-t border-white/10 pt-12 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-white/60">
                <li>
                  <a href={`mailto:${emailAddress}`} className="flex items-center gap-2 transition-colors hover:text-white">
