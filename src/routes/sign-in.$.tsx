...
// Splat route: catches every sub-step Clerk needs under /sign-in/ (Google SSO
// callback, verification steps, etc.) so the static host doesn't 404 on them —
// it just renders the same sign-in screen, and Clerk's own internal routing
